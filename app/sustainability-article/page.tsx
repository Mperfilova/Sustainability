        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <article className="prose max-w-4xl mx-auto">
            ...
            <div className="pl-8 space-y-4">
              <p className="text-sm">Halpern, B. S., Walbridge, S., Selkoe, K. A., Kappel, C. V., Micheli, F., D'Agrosa, C., Watson, R. (2008). A global map of human impact on marine ecosystems. <em>Science, 319</em>(5865), 948–952.</p>
              ...
              <p className="text-sm">Lester, S. E., Halpern, B. S., Grorud-Colvert, K., Lubchenco, J., Ruttenberg, B. I., Gaines, S. D., Warner, R. R. (2009). Biological effects within no-take marine reserves: a global synthesis. <em>Marine Ecology Progress Series, 384</em>, 33–46.</p>
              
              <p className="text-sm">Pauly, D., Christensen, V., Guénette, S., Pitcher, T. J., Sumaila, U. R., Walters, C. J., Zeller, D. (2002). Towards sustainability in world fisheries. <em>Nature, 418</em>(6898), 689–695.</p>
              
              <p className="text-sm">United Nations. (1987). <em>Report of the World Commission on Environment and Development: Our Common Future</em>.</p>
            </div>
          </article>
        </div>
      </div>
